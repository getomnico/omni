<script lang="ts">
    ...
    let {
        sources = [] as McpSource[],
        manifestBySourceType = {} as Record<string, ManifestInfo>,
    }: { sources: McpSource[]; manifestBySourceType: Record<string, ManifestInfo> } = $props()
...
<div class="space-y-4">
    <div class="flex items-center justify-between gap-4">
        <div>
            <h2 class="text-xl font-semibold">Remote MCP Servers</h2>
                ...
                <button
                    ...
                    <div class="min-w-0 flex-1 space-y-1">
                        <div class="flex flex-wrap items-center gap-2">
                            ...
                            {#if !source.config.write_tools_enabled}
    ...
    {:else}
        <div class="rounded-lg border border-dashed py-12 text-center">
            ...
            <p class="text-muted-foreground mt-3 text-sm">No remote MCP servers configured yet.</p>
        ...
        <Dialog.Content
            ...
            <div class="space-y-5 py-4">
                <div class="space-y-2">
                    ...
                    <Input id="mcp-name" bind:value={name} placeholder="Acme MCP" />
                </div>
                <div class="space-y-2">
                ...
                <div class="space-y-2">
                    <Label for="mcp-slug">App/source slug</Label>
                    <Input id="mcp-slug" bind:value={sourceType} placeholder="acme" />
