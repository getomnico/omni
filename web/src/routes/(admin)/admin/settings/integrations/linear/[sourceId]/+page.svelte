...
<svelte:head>
    <title>Configure Linear - {data.source.name}</title>
</svelte:head>
            ...
            <Card.Root class="relative">
                    ...
                    <div class="flex items-start justify-between">
                        <div>
                            <Card.Title class="flex items-center gap-2">
                                <img src={linearLogo} alt="Linear" class="h-5 w-5" />
                                {data.source.name}
                            </Card.Title>
                            <Card.Description class="mt-1">
                                Index issues, projects, documents, and project updates from Linear
                            </Card.Description>
                        </div>
                ...
                <Card.Content>
                    <p class="text-muted-foreground text-sm">
                        All accessible issues, projects, documents, and project updates will be
                        indexed from your Linear workspace.
                    </p>
                </Card.Content>
