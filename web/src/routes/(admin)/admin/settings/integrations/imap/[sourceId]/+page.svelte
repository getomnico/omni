        ...
        <Card.Content class="space-y-6">
                ...
                <div class="space-y-1.5">
                    ...
                    {#if encryption === 'none'}
                        <p class="text-destructive text-xs">
                            Warning: plaintext mode transmits your password without encryption.
                        </p>
                    {/if}
            ...
            <div class="space-y-4 border-t pt-4">
                ...
                <div class="space-y-2">
                    ...
                    <p class="text-muted-foreground text-xs">
                        Leave empty to sync all folders. If set, only listed folders are indexed.
                    </p>
                    ...
                    {#if folderAllowlist.length > 0}
                        <div class="flex flex-wrap gap-2">
                            {#each folderAllowlist as folder}
                                <input type="hidden" name="folderAllowlist" value={folder} />
                                <div
