...
resource "aws_service_discovery_service" "google_ads_connector" {
...
resource "aws_service_discovery_service" "windshift_connector" {
  count = contains(var.enabled_connectors, "windshift") ? 1 : 0

  name = "windshift-connector"
